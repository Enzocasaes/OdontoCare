...
const treatmentRepository = new TreatmentRepository(prisma);
...
const financeService = new FinanceService({ paymentRepository, treatmentRepository, activityLogRepository });
